...
INSERT INTO tb_faixa_etaria (idade, descricao) VALUES ('+14', 'Livre para maiores de 14 anos');
INSERT INTO tb_faixa_etaria (idade, descricao) VALUES ('+16', 'Livre para maiores de 16 anos');
INSERT INTO tb_faixa_etaria (idade, descricao) VALUES ('+18', 'Livre para maiores de 18 anos');
...
ALTER TABLE tb_plano MODIFY COLUMN valor VARCHAR(8);
...
ALTER TABLE tb_cartao_credito MODIFY COLUMN numero VARCHAR(15);
INSERT INTO tb_cartao_credito (numero, dt_vencmento, cod_seguranca, titular)
VALUES 
	('12345678901', '2023-12-31', '12345678', 'João Silva'), /*parece q o padrão INT n suporta numeros grandes e eu esqueci disso*/
	('98765432109', '2024-06-30', '87654321', 'Maria Santos'),
	('53454238633', '2025-03-31', '99997788', 'Pedro Oliveira');

select * from tb_cliente;
ALTER TABLE tb_cliente MODIFY COLUMN cpf VARCHAR(15);
INSERT INTO tb_cliente 
	(cpf, dt_vencimento, id_plano, id_cartao_credito) 
VALUES 
	('1234567890', '2023-12-31', 1, 1),
	('0000000004', '2024-06-30', 2, 2),
	('1111111114', '2025-03-31', 3, 3);
...
INSERT INTO tb_usuario 
    (senha, dt_cadastro, nome, sobrenome, email, atividade, dt_nascimento, id_cliente) 
VALUES
    ('senha123', '2023-06-01', 'João', 'Silva', 'joao@email.com', 1, '1990-05-15', 25),
    ('abc123', '2023-06-02', 'Maria', 'Santos', 'maria@email.com', 1, '1988-10-20', 26),
    ('senha127', '2023-06-01', 'João', 'Silva', 'joao@email.com', 1, '1990-05-15', 27);
...
VALUES (1, 'Rua A', 'Quadra 1', 'Centro', 'São Paulo', 1),
 (2, 'Rua B', 'Quadra 2', 'Copacabana', 'Rio de Janeiro', 1),
(3, 'Rua C', 'Quadra 3', 'Savassi', 'Belo Horizonte', 1),
 (4, ' Avenida Afonso Pena ', 'Quadra 2', 'Copacabana', 'Rio de Janeiro', 1);
select * from tb_perfil;
INSERT INTO tb_perfil 
	(foto, nome, tipo, id_cliente) 
VALUES 
	('foto', 'lucas ', 'normal', 23),
    ('foto', 'joão', 'infantil', 24),
    ('foto', 'maria', 'normal', 25),
    ('foto', 'pedro', 'normal', 26);
select * from tb_idioma;
INSERT INTO tb_idioma (nome) VALUES ('Brasileiro');
INSERT INTO tb_idioma (nome) VALUES ('Inglês');
INSERT INTO tb_idioma (nome) VALUES ('Europeu');
...
VALUES 
	('Benedict', 'Cumberbatch', '1976-07-19', 'foto'),
	('Martin', 'Freeman', '1971-09-08', 'foto'),
	('Keanu', 'Reeves', '1964-09-02', 'foto'),
	('Laurence', 'Fishburne', '1961-07-30', 'foto');
select * from tb_catalogo;
INSERT INTO tb_catalogo 
	(id_catalogo, pais_origem, imagem_capa, titulo, sinopse, dt_lancamento, idioma_original, duracao, id_pais, id_faixa_etaria, id_idioma)
VALUES 
	(1, 'Estados Unidos', 'capa', 'The Matrix', 'The Matrix acompanha a aventura de Neo, um jovem hacker que é 
    chamado para o movimento de resistência liderado por Morpheus, na luta contra a dominação dos humanos pelas máquinas.', '1999-03-31', 'Inglês', '2:16:00', 2, 4, 2),
	(2,  'Reino Unido', 'capa', 'Sherlock', 'Sir Arthur Conan Doyle, Sherlock conta as aventuras do detetive particular Sherlock Holmes e seu fiel 
    escudeiro, na Inglaterra dos dias de hoje.', '2010-07-25', 'Inglês', '1:30:00', 3, 3, 3);

INSERT INTO tb_filme (id_filme, oscar, id_catalogo)
VALUES (1, 'Melhor Filme 1999', 1);

INSERT INTO tb_serie (id_serie, qtd_temporada, id_catalogo)
VALUES (1,4,2 );

select * from tb_temporada;
ALTER TABLE tb_temporada MODIFY COLUMN descricao VARCHAR(255);
INSERT INTO tb_temporada 
(id_temporada, titulo, descricao)
VALUES 
(1, 'A Scandal in Belgravia', 'A monarquia é ameaçada pelo surgimento de algumas fotografias comprometedoras. Sherlock é logo colocado no caso e descobre ligações entre o terrorismo internacional e a corrupção no governo britânico.'),
(2, 'The Hounds of Baskerville', 'Henry Knight afirma que seu pai foi morto por uma criatura monstruosa em Dartmoor, e pede a Sherlock para ajudá-lo. Quando ele e John Watson chegam para investigar, eles descobrem que uma base militar ultra-secreta pode estar ligada à morte.'),
(3, 'The Reichenbach Fall', 'Moriarty dá início ao que pode ser o crime do século: invadir a Torre de Londres, o Banco da Inglaterra e a Prisão de Pentonville.'),
(4, 'Many Happy Returns', 'Uma série de crimes aparentemente desconexos, estendendo-se do Tibet, Índia e Alemanha. Sherlock Holmes desapareceu há dois anos. Mas alguém não está muito convencido de que ele está morto.'),
(5, 'The Six Thatchers', 'Um caso misterioso em especial confunde a Scotland Yard - mas Sherlock está mais interessado em um detalhe aparentemente-trivial.'); 
...
INSERT INTO tb_catalogo_idioma (id_catalogo, id_idioma) VALUES (2, 2);
...
INSERT INTO tb_catalogo_ator (id_catalogo, id_ator) VALUES (1, 3);
INSERT INTO tb_catalogo_ator (id_catalogo, id_ator) VALUES (1, 4);
INSERT INTO tb_catalogo_ator (id_catalogo, id_ator) VALUES (2, 1);
INSERT INTO tb_catalogo_ator (id_catalogo, id_ator) VALUES (2, 2);



INSERT INTO tb_catalogo_faixa_etaria (id_catalogo, id_faixa_etaria) VALUES ('1','4');
INSERT INTO tb_catalogo_faixa_etaria (id_catalogo, id_faixa_etaria) VALUES ('2','3');
...
VALUES 						(1,         9.99, '2025-02-09',        1,             3,                27),
	                        (2,         9.99, '2023-11-18',        2,             4,                26),
							(3,         9.99, '2024-05-16',        3,             1,                25);
...
DELIMITER //
CREATE PROCEDURE sp_deletar_catalogo_faixa_etaria(
    IN cod_catalogo INT,
    IN cod_faixa_etaria INT
)
BEGIN
    DELETE FROM catalogo_faixa_etaria
    WHERE id_catalogo = cod_catalogo AND id_faixa_etaria = cod_faixa_etaria;
END //
DELIMITER ;


DELIMITER //
CREATE PROCEDURE sp_deletar_catalogo_ator(
    IN cod_catalogo INT,
    IN cod_ator INT
)
BEGIN
    DELETE FROM catalogo_ator
    WHERE id_catalogo = cod_catalogo AND id_ator = cod_ator;
END //
DELIMITER ;


DELIMITER //
CREATE PROCEDURE sp_deletar_catalogo_idioma(
    IN cod_catalogo INT,
    IN cod_idioma INT
)
BEGIN
    DELETE FROM catalogo_idioma
    WHERE id_catalogo = cod_catalogo AND id_idioma = cod_idioma;
END //
DELIMITER ;
...
CREATE PROCEDURE sp_inserir_catalogo_ator(
    IN cod_id_catalogo INT,  
    IN cod_id_ator INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE sp_inserir_catalogo_idioma(
    IN cod_id_catalogo INT,
    IN cod_id_idioma INT
)
BEGIN
    INSERT INTO catalogo_idioma (id_catalogo, id_idioma)
...
BEGIN
    INSERT INTO catalogo_ator (id_catalogo, id_ator)
    VALUES (cod_id_catalogo, cod_id_ator);
END //
DELIMITER ;
...
CREATE PROCEDURE sp_inserir_usuario(
    IN cod_senha VARCHAR(8),  
    IN cod_dt_cadastro DATE,  
    IN cod_nome VARCHAR(50),  
    IN cod_sobrenome VARCHAR(50), 
    IN cod_email VARCHAR(50),  
    IN cod_atividade TINYINT(1),  
    IN cod_dt_nascimento DATE,  
    IN cod_id_cliente INT
)
BEGIN
    INSERT INTO tb_usuario (
        senha, dt_cadastro, 
        nome, sobrenome, 
        email, atividade, 
        dt_nascimento, id_cliente
    )
    VALUES (
        cod_senha, cod_dt_cadastro, 
...
DELIMITER //
CREATE PROCEDURE sp_inserir_serie_temporada(
    IN cod_id_serie INT,
    IN cod_id_temporada INT
)
BEGIN
    INSERT INTO serie_temporada (id_serie, id_temporada)
    VALUES (cod_id_serie, cod_id_temporada);
END //
DELIMITER ;
